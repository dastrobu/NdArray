...
/**
 Examples in the README.md before the new slice API was introduced. Keep while API is deprecated.
 All examples should at least compile with warnings.
 */
class OldReadmeExamples: XCTestCase {
    func testAliasing() {
